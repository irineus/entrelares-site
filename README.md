...
- [x] **Responsive blog images** (**L-04**, 13/09/2026) — the four illustrated articles serve
      ...
      322 KB to ~80 KB. Generated by `assets-src/blog-images.py`, guarded by
      `test/blog-images.test.js`; the 1600 px masters stay untouched as each article's
      `og:image`, and the sitemap `lastmod` did not move — the content did not change.
